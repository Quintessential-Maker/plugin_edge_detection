...
```
pod 'WeScan', :path => '.symlinks/plugins/plugin_edge_detection/ios/WeScan-3.0.0'
```
...
```
import 'package:plugin_edge_detection/edge_detection.dart';
```
